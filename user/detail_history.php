...
$peminjamanQuery = "SELECT buku.judul, peminjaman.tanggal_peminjaman, peminjaman.tanggal_pengembalian
                    FROM peminjaman
                    INNER JOIN buku ON peminjaman.buku = buku.id
                    WHERE peminjaman.user = $userId AND peminjaman.status_peminjaman = 'Dikembalikan' AND peminjaman.buku = $bukuId";
$peminjamanResult = mysqli_query($conn, $peminjamanQuery);

// Hitung jumlah total data
$totalData = mysqli_num_rows($peminjamanResult);
...
// Query untuk mengambil data peminjaman berdasarkan user dan limit per halaman
$peminjamanQuery = "SELECT buku.judul, peminjaman.tanggal_peminjaman, peminjaman.tanggal_pengembalian
                    FROM peminjaman
                    INNER JOIN buku ON peminjaman.buku = buku.id
                    WHERE peminjaman.user = $userId AND peminjaman.status_peminjaman = 'Dikembalikan' AND peminjaman.buku = $bukuId
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 style="margin-top: 90px;" class="h3 text-gray-800 text-center">History Peminjaman Buku</h1>
                        ...
                        <nav aria-label="Page navigation">
                            <ul class="pagination justify-content-center">
                                ...
                                <li class="page-item <?php echo ($currentPage == 1) ? 'disabled' : ''; ?>">
                                    <a class="page-link" href="?id=<?php echo $bukuId; ?>&page=<?php echo $currentPage - 1; ?>" aria-label="Previous">
                                ...
                                <?php for ($i = max(1, $currentPage - 2); $i <= min($totalPages, $currentPage + 2); $i++) : ?>
                                    <li class="page-item <?php echo ($i == $currentPage) ? 'active' : ''; ?>">
                                        <a class="page-link" href="?id=<?php echo $bukuId; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                                    </li>
                                <?php endfor; ?>

                                <!-- Tombol Next -->
                                <li class="page-item <?php echo ($currentPage == $totalPages) ? 'disabled' : ''; ?>">
                                    <a class="page-link" href="?id=<?php echo $bukuId; ?>&page=<?php echo $currentPage + 1; ?>" aria-label="Next">
        ...
        <!-- Footer -->
             <footer style="margin-top: 100px; box-shadow: 0 -7px 17px 0 rgba(0,0,0,0.4);" class=" footer bg-light text-center py-4 border-top">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
