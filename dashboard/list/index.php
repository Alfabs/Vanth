...
$query = "SELECT buku.id AS buku_id, buku.judul, buku.cover, ulasan_buku.ulasan, ulasan_buku.rating,
                  COUNT(ulasan_buku.id) AS jumlah_ulasan,
                  AVG(ulasan_buku.rating) AS rata_rata_rating
           FROM buku
...
$total_books_query = "SELECT COUNT(DISTINCT buku.id) as total FROM buku LEFT JOIN ulasan_buku ON buku.id = ulasan_buku.buku";
            ...
            <!-- Topbar -->
              ...
              <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <a href="../buku/tambah-buku.php" class="mb-4 btn btn-primary">Tambah Buku</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if (!empty($row['cover'])) :?>
                                <img src="../buku/cover/<?=$row['cover'];?>" alt="Cover" width="50">'
                            <?php else :?>
                                Tidak ada Cover
                            <?php endif;?>
                        </td>
                        ...
                        <td><?= number_format($row['rata_rata_rating'], 2); ?></td>
                        <td class="text-center">
                            <a class="badge badge-primary" href="tambah-ulasan.php?id=<?= $row['buku_id']; ?>">Tambah Ulasan</a>
                            <a class="badge badge-warning" href="lihat-ulasan.php?id=<?= $row['buku_id']; ?>">Lihat Ulasan</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
