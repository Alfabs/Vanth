...
$kategori = "SELECT * FROM kategori_buku WHERE id = $kategori_id";
$query = mysqli_query($conn, $kategori);
$resultKategori = mysqli_fetch_assoc($query);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insert_kategori_query = "UPDATE kategori_buku SET nama_kategori = '$kategori' WHERE id = $kategori_id";

    $insert_kategori_result = mysqli_query($conn, $insert_kategori_query);

    if ($insert_kategori_result) {
        // Setelah penyimpanan berhasil
        header('location: kategori.php');
        $_SESSION['success'] = "Pembaruan Kategori Berhasil";
    } else {
    ...
    <?php if($userRole == "petugas") :?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid col-lg-6">
                ...
                <form class="user" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?id=<?php echo $kategori_id; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control rounded" id="Kategori" name="kategori" placeholder="Kategori" required><?=$resultKategori['nama_kategori'];?></textarea>
                    </div>
